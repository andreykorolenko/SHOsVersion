...
// SHOsVersion
#define COCOAPODS_POD_AVAILABLE_SHOsVersion
#define COCOAPODS_VERSION_MAJOR_SHOsVersion 1
#define COCOAPODS_VERSION_MINOR_SHOsVersion 0
#define COCOAPODS_VERSION_PATCH_SHOsVersion 0
